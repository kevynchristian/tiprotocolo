        ...
        <div class="card mb-4">
            ...
            <div class="container text-center">
                <div class="row align-items-start">
                    ...
                    <div class="col-4">
                        <div class="mb-3">
                            <input id="pesquisa" type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Pesquisa">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach ($protocolos as $protocolo)
                                <tr id="protocolo-{{ $protocolo->id }}">
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <button onclick="pdf({{ $protocolo->id }})" type="button"
                                            class="btn btn-secondary"><i class="bi bi-filetype-pdf"></i></button>
                                        <button onclick="exibirIdParaExcluir({{ $protocolo->id }})"
